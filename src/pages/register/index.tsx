      ...
      <main className="min-h-screen bg-white text-gray-800 py-20 px-4">
        <div className="max-w-xl mx-auto">
          <h1 className="text-3xl font-bold text-red-700 mb-8 text-center">Formulir Pendaftaran</h1>
            <p className="text-center pb-10">Sudah punya akun? <Link href='/login' className="underline">LogIn</Link> </p>
                  
          <form onSubmit={handleSubmit} className="space-y-6 bg-red-50 p-8 rounded-xl shadow">
            <div>
              <label htmlFor="nama" className="block font-semibold text-red-700 mb-1">Nama</label>
              <input
                type="text"
                id="nama"
                name="nama"
            ...
            <div>
              <label htmlFor="bidang" className="block font-semibold text-red-700 mb-1">Pilih Bidang Lomba</label>
              <select
                id="bidang"
                name="bidang"
                value={form.bidang}
